...
const translations: Translations = {
  ...
  securityDescription: { ru: 'Обзор безопасности системы и правила файрволла', en: 'System security overview and firewall rules' },
  firewallRules: { ru: 'Правила файрволла', en: 'Firewall Rules' },
  noRulesInDb: { ru: 'Нет активных правил', en: 'No active rules' },
  recentEvents: { ru: 'Недавние события', en: 'Recent Events' },
  ...
  connectBot: { ru: 'Подключить бота', en: 'Connect New Bot' },
  manageBot: { ru: 'Управление ботами', en: 'Manage your isolated bot instances' },
  running: { ru: 'Запущен', en: 'Running' },
  stopped: { ru: 'Остановлен', en: 'Stopped' },
  botToken: { ru: 'Токен бота', en: 'Bot Token' },
  tokenHint: { ru: 'Введите токен от @BotFather', en: 'Enter the token from @BotFather' },
  storageQuota: { ru: 'Квота хранилища', en: 'Storage Quota' },
  dedicatedVolume: { ru: 'Выделенный диск', en: 'Dedicated Volume' },
  volumeDesc: { ru: 'Будет создан логический диск на медиа накопителе. БД будет изолирована.', en: 'A logical volume will be created on the media disk. Database will be isolated.' },
  createBot: { ru: 'Создать бота', en: 'Create Bot & Volume' },
  creating: { ru: 'Создание...', en: 'Creating Environment...' },
  deleteBotTitle: { ru: 'Удалить окружение бота?', en: 'Delete Bot Environment?' },
  deleteBotDesc: { ru: 'Это действие необратимо. Будут удалены:', en: 'This action is irreversible. It will permanently delete:' },
  deleteEverything: { ru: 'Удалить всё', en: 'Delete Everything' },
  activeUsers: { ru: 'пользователей', en: 'active users' },
  start: { ru: 'Запуск', en: 'Start' },
  stop: { ru: 'Стоп', en: 'Stop' },
  restart: { ru: 'Рестарт', en: 'Restart' },
  config: { ru: 'Конфиг', en: 'Config' },
  sourceType: { ru: 'Источник кода', en: 'Source Code' },
  gitRepo: { ru: 'Git Репозиторий', en: 'Git Repository' },
  uploadZip: { ru: 'Загрузить ZIP', en: 'Upload ZIP' },
  uploadDesc: { ru: 'Перетащите архив с кодом сюда', en: 'Drag and drop code archive here' },
  selectFile: { ru: 'Выбрать файл', en: 'Select File' },
  
  // Bot Dashboard
  botStudioOverview: { ru: 'Обзор Bot Studio', en: 'Bot Studio Overview' },
  totalBots: { ru: 'Всего ботов', en: 'Total Bots' },
  deployedInstances: { ru: 'Развёрнутые инстансы', en: 'Deployed instances' },
  acrossAllBots: { ru: 'Во всех ботах', en: 'Across all bots' },
  globalStorageUsage: { ru: 'Использование хранилища', en: 'Global Storage Usage' },
  totalPhysicalSpaceOccupied: { ru: 'Занято физического места', en: 'Total Physical Space Occupied' },
  limit: { ru: 'Лимит', en: 'Limit' },
  messagesToday: { ru: 'Сообщения сегодня', en: 'Messages Today' },
  volumeVsYesterday: { ru: 'Объем vs вчера', en: 'Volume vs yesterday' },
  autoConnectedServices: { ru: 'Авто-подключенные сервисы', en: 'Auto-Connected Services' },
  localServicesDescription: { ru: 'Локальные сервисы, автоматически связанные с окружением ботов.', en: 'Local services automatically linked to your bots environment.' },
  currentStatusAndLoad: { ru: 'Текущий статус и нагрузка.', en: 'Current status and load.' },
  noBotsConnected: { ru: 'Боты еще не подключены.', en: 'No bots connected yet.' },
  botCreatedSuccess: { ru: 'Бот успешно создан и связан с сервисами', en: 'Bot created and linked to local services' },
  botDeletedSuccess: { ru: 'Окружение бота и изолированные ресурсы удалены', en: 'Bot environment and isolated resources deleted' },
  botStatusChanged: { ru: 'Бот теперь', en: 'Bot is now' },
  tokenExistsError: { ru: 'Бот с таким токеном уже существует', en: 'A bot with this token already exists' },
  gitUrlError: { ru: 'Пожалуйста, введите корректный Git URL', en: 'Please enter a valid Git Repository URL' },
  zipError: { ru: 'Пожалуйста, выберите ZIP архив', en: 'Please select a ZIP archive to upload' },
  
  // Dashboard Services
  connected: { ru: 'Подключено', en: 'Connected' },
  linked: { ru: 'Связано', en: 'Linked' },
  localAi: { ru: 'Локальный AI Хаб', en: 'Local AI Hub' },
  sharedDb: { ru: 'Общий кластер БД', en: 'Shared Database Cluster' },
};
